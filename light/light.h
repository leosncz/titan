...
{
  public:
     light() { computeShadows = true;  type = DIRECTIONNAL_LIGHT; cutOff = glm::cos(glm::radians(12.5f));  lightPosition = vec3(0, 0, 0); lightColor = vec3(1, 1, 1); lightDirection = vec3(0, 0, -1); constant = 1.0; linear = 0.19; quadratic = 0.032; }
