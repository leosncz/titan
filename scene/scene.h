...
public:
    ...
    {
        if (m_cameraAutoGenerated == true)
        {
            m_cameraAutoGenerated = false;
...
private:
    ...
    bool m_cameraAutoGenerated; // Used to know if the camera has been automatically generated
